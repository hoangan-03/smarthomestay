...
const graphdata = {
    ...
    lightlevel: {
        text: "Light Level Record",
        title: "Light Level (Lux)",
        format: "0",
        dataPoints: [
            { x: new Date("2018-03-01"), y: 85 },
            { x: new Date("2018-03-02"), y: 83 },
            { x: new Date("2018-03-05"), y: 81 },
            { x: new Date("2018-03-06"), y: 84 },
            { x: new Date("2018-03-07"), y: 84 },
            { x: new Date("2018-03-08"), y: 74 },
            { x: new Date("2018-03-09"), y: 65 },
            { x: new Date("2018-03-12"), y: 35 },
            { x: new Date("2018-03-13"), y: 54 },
            { x: new Date("2018-03-14"), y: 84 },
            { x: new Date("2018-03-15"), y: 95 },
            { x: new Date("2018-03-16"), y: 55 },
            { x: new Date("2018-03-19"), y: 65 },
            { x: new Date("2018-03-20"), y: 85 },
            { x: new Date("2018-03-21"), y: 26 },
            { x: new Date("2018-03-22"), y: 44 },
            { x: new Date("2018-03-23"), y: 34 },
            { x: new Date("2018-03-26"), y: 45 },
            { x: new Date("2018-03-27"), y: 65 },
            { x: new Date("2018-03-28"), y: 56 },
            { x: new Date("2018-03-29"), y: 77 }
        ]
    },
    humidity: {
        text: "Humidity Record",
        title: "Humidity (in %)",
        format: "0",
        dataPoints: [
            { x: new Date("2018-03-01"), y: 85 },
